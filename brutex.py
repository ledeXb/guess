...
jalan("\033[1;91m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█")
jalan("\033[1;91m█------////////<<<<< █")
jalan("\033[1;91m█---- \033[1;92mWelcome To <<< █")
jalan("\033[1;91m█------////////<<<<< █")
jalan("\033[1;91m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█")
...
# main script start
os.system("xdg-open https://youtube.com/@LinuxXB")
time.sleep(5)
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://t.me/Linixxb")
